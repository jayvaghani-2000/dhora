export default function TermsPages() {
  return (
    <div className="container flex flex-col prose prose-invert">
      <h1>Website Terms and Conditions of Use</h1>

      <h2>1. Terms</h2>

      <p>
        By accessing this Website, accessible from dhora.app, you are agreeing
      ...
      <p>
        This will let Dhora to terminate upon violations of any of these
      ...
      <p>
        ...
        without notice. Dhora does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        Dhora may revise these Terms of Use for its Website at any time without
