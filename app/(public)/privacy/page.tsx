  ...
  return (
    <div className="container flex flex-col prose prose-invert">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Dhora, the software program
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Dhora.app, accessible from{" "}
            <a
              href="https://dhora.app"
      ...
      <ul>
        <li>By email: policy@dhora.app</li>
      </ul>
    </div>
  );
}
