import { validateTextField } from "@/lib/advanced-fields-validation/validate-text";
import { type TTextFieldMeta as TextFieldMeta } from "@/lib/types/field-meta";
  ...
  const handleInput = (field: keyof TextFieldMeta, value: string | boolean) => {
    ...
    const limit =
      field === "characterLimit"
        ? Number(value)
        : Number(fieldState.characterLimit || 0);
    const readOnly =
