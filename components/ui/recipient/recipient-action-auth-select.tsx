...
import { DOCUMENT_AUTH_TYPES } from "@/lib/constants/document-auth";
import { RecipientActionAuth } from "@/lib/types/document-auth";
import {
  Select,
  SelectContent,
  SelectItem,
...
export const RecipientActionAuthSelect = (
  props: RecipientActionAuthSelectProps
) => {
  return (
    <Select {...props}>
        ...
        <Tooltip>
          ...
          <TooltipContent className="text-foreground max-w-md p-4">
            ...
            <ul className="ml-3.5 list-outside list-disc space-y-0.5 py-2">
              <li>
                <strong>Inherit authentication method</strong> - Use the global
                action signing authentication method configured in the "General
                Settings" step
              </li>
              {/* <li>
              ...
              <li>
                <strong>Require passkey</strong> - The recipient must have an
                account and passkey configured via their settings
              </li>
              <li>
